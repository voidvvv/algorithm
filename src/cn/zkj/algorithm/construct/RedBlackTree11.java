...
/**
 * @Classname RedBlackTree11
 * @Description 2022年2月22日22:16:55
 * @Date 2022/2/22 22:15
 * @Created by zkj
 */
public class RedBlackTree11<T extends Comparable<T>> {
    private Node root;
    class Node{
        boolean red;
        Node left;
    ...
    private void fixAfterInsert(Node x) {
        ...
        while (x!=null && redOf(parentOf(x))){
            if (isLeft(parentOf(x))){
                ...
                Node unlce = leftOf(grandParentOf(x));
    ...
    public void traverse(){
        Queue<RedBlackTree11.Node> queue = new LinkedList<>();
        Queue<RedBlackTree11.Node> queue2 = new LinkedList<>();
        ...
        while (true){
            ...
            if (!queue.isEmpty()){
                while (!queue.isEmpty()){
                    RedBlackTree11.Node poll = queue.poll();
                    if (poll==null){
                        print.append("null\t");
                    }else {
                        f= false;
                ...
                while (!queue2.isEmpty()){
                    RedBlackTree11.Node poll = queue2.poll();
                    if (poll==null){
                        print.append("null\t");
                    }else {
                        f= false;
    ...
    public static void main(String[] args) {
        RedBlackTree11<Integer> tree = new RedBlackTree11<Integer>();
