...
/**
 * @Classname RedBlackTree10
 * @Description 2022年2月21日21:09:49 2022年2月21日21:45:29
 * @Date 2022/2/21 21:08
 * @Created by zkj
 */
public class RedBlackTree10 <T extends Comparable<T>>{
    private Node root;
    class Node{
        boolean red;
        Node parent;
...
//        Node x = ;
        fixAfterInsert(addChild(p,data));

    }

    private Node addChild(Node p, T data) {
    ...
    public static void main(String[] args) {
        RedBlackTree10<Integer> tree = new RedBlackTree10<Integer>();
