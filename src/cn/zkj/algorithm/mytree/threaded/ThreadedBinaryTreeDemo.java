package cn.zkj.algorithm.mytree.threaded;
...
class BinaryTree{
    ...
    public BinaryTreeNode pre =null;
    ...
    public void midThreadedTree(BinaryTreeNode root){
        if (root==null){
            System.out.println("为空，无法线索化");
            return;
        }

        midThreadedTree(root.left);
