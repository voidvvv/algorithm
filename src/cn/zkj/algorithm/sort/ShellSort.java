...
//                    将index前一位的索引取出，用以比较
    ...
    public void shellSort11(int[] arr){
        for (int gap=arr.length/2;gap>0;gap/=2){
            for (int x=gap;x<arr.length;x++){
                int y = x-gap;
                int cur = arr[x];
    ...
    public void shellSort12(int[] arr){
        for (int gap = arr.length/2;gap>0;gap/=2){
            for (int x=gap;x<arr.length;x+=gap){
                int y = x-gap;
                int minVal = arr[x];
    ...
    public void shellSort15(int[] arr){
        for (int gap = arr.length/2;gap>0;gap=2){
            for (int x=gap;x<arr.length;x++){
                int y = x-gap;
                int v =arr[x];
    ...
    public static void main(String[] args) {
        ...
        MyPrinter.printDefaultArrays(s::shellSort15);
